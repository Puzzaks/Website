  ...
  Widget build(BuildContext context) {
    ...
    return DynamicColorBuilder(builder: (lightColorScheme, darkColorScheme) {
      return MaterialApp(
        ...
        home: Consumer<backend>(builder: (context, backend, child) {
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        headerLine("About", 3, Colors.teal, scaffoldWidth-30),
                        Container(
                          width: scaffoldWidth,
                          child: const Padding(
                        ...
                        headerLine("Telemetry", telemetry["uptime"] == 0?1:7, Colors.teal, scaffoldWidth-30),
                        ...
                        headerLine("Russian Casualties", rusnya.isEmpty?1:15, Colors.teal, scaffoldWidth-30),
