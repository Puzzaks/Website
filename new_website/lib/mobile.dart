                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      headerLine(
                          "Telemetry",
                          backend.telemetry["uptime"] == 0 ? 1 : 7,
                          scaffoldWidth - 30),
                      backend.isLoading
                          ? Container(
                              width: scaffoldWidth,
                      ...
                      headerLine("Russian Casualties",
                          backend.rusnya.isEmpty ? 1 : 15, scaffoldWidth - 30),
                      ...
                      backend.news == {} || backend.news["projects"] == null
                          ...
                          : headerLine(
                              "Projects", backend.news["projects"].length),
                      Container(
                        width: scaffoldWidth,
                        child: SingleChildScrollView(
                          scrollDirection: Axis.horizontal,
                          child: backend.news == {} ||
                                  backend.news["projects"] == null
                              ? Container()
                              : Row(
                                  children: backend.news["projects"]
                                      .toList()
                                      .map((piece) {
                                        String url = piece["content"]["type"] ==
                                                "md"
                                            ? "https://stories.puzzak.page/${piece["id"]}"
                                            : piece["content"]["body"];
                                        return projectCard(
                                            Image.network(
                      ...
                      Container(
                        width: scaffoldWidth,
                        child: backend.news == {} ||
                                backend.news["news"] == null
                            ? Container()
                            : Column(
                                children: backend.news["news"]
                                    .toList()
                                    .map((piece) {
                                      String url = piece["content"]["type"] ==
                                              "md"
